                    ...
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                        ...
                        <div class="2xl:flex mt-5 mb-3">
                            <div class="flex items-center justify-center sm:justify-start">
                                <div class="text-white relative text-2xl 2xl:text-3xl font-medium leading-6 pl-3 2xl:pl-4">
                                    <span class="absolute text-xl 2xl:text-2xl top-0 left-0 -mt-1 2xl:mt-0">$</span> 18,402,210
                                </div>
                            ...
                            <div class="mt-5 2xl:flex 2xl:justify-center 2xl:mt-0 2xl:-ml-20 2xl:w-14 2xl:flex-none 2xl:pl-2.5">
                                <div class="font-medium inline-flex bg-theme-20 text-white rounded-full px-2 py-1 text-xs 2xl:text-sm 2xl:p-0 2xl:text-theme-20 2xl:bg-transparent 2xl:flex items-center tooltip cursor-pointer 2xl:justify-center" title="49% Higher than last month">
                        ...
                        <div class="2xl:text-base text-theme-34 mt-6 -mb-1">
                            Total net margin <span class="font-medium">$921,050</span>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <div class="mr-auto">
                                ...
                                <div class="text-white relative text-2xl font-medium leading-5 pl-4 mt-3.5">
                                    <span class="absolute text-xl top-0 left-0 -mt-1.5">$</span> 47,578.77
                                </div>
                            </div>
                            <a class="flex items-center justify-center w-12 h-12 rounded-full bg-theme-26 dark:bg-dark-1 hover:bg-opacity-80 text-white" href="">
                                ...
                                <div class="tab-pane active grid grid-cols-12 gap-y-6" id="active-users" role="tabpanel" aria-labelledby="active-users-tab">
                                    ...
                                    <div class="col-span-12 sm:col-span-6 md:col-span-4 xl:col-span-12">
                                        ...
                                        <div class="mt-1.5 flex items-center">
                                            ...
                                            <div class="text-theme-20 flex text-xs font-medium tooltip cursor-pointer ml-2" title="0.1% Lower than last month">
                                                49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                            </div>
                                        </div>
                                    </div>
