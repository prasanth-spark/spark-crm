                    ...
                    <form class="validate-form" action="{{route('employee-add')}}" method="post" id="theForm">
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div class="input-form mt-3">
                                    <label for="regular-form-4" class="form-label w-full flex flex-col sm:flex-row">
                                        password<span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-gray-600">Required, Password</span>
                                    </label>
                                    <input id="regular-form-4" type="password" class="form-control" placeholder="Password" name='password' required>
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-6">
                                <div class="input-form mt-3">
