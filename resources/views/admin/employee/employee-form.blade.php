                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="validation-form-1" type="text" class="form-control" placeholder="Name" name="name" >
                                    @error('name')
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="validation-form-2" type="text" class="form-control" placeholder="Father Name" name='father_name' >
                                    @error('father_name')
                                          <span style="color:red">{{$message}}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-3" type="text" class="form-control" placeholder="Mother Name" name='mother_name' >
                                    @error('mother_name')
                                          <span style="color:red">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-3" type="number" class="form-control" placeholder="Phone Number" name='phone_number' >
                                    @error('phone_number')
                                          <span style="color:red">{{$message}}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-3" type="number" class="form-control" placeholder="Emergency Contact Number" name='emergency_contact_number' >
                            ...
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-4" type="email" class="form-control" placeholder="Email" name='email' >
                                    @error('email')
                                          <span style="color:red">{{$message}}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-4" type="email" class="form-control" placeholder="Official Email" name='official_email' >
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-4" type="text" class="form-control" placeholder="Home Address" name='home_address' >
                                    @error('home_address')
                                          <span style="color:red">{{$message}}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-4" type="text" class="form-control" placeholder="Blood Group" name='blood_group' >
                                    @error('blood_group')
                                          <span style="color:red">{{$message}}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="grid grid-cols-12 gap-6 mt-5">
                            <div class="col-span-12 md:col-span-6">
                                <div>
                                    ...
                                    <input id="regular-form-4" type="number" class="form-control" placeholder=" Aadhar Number" name='aadhar_number' >
                                </div>
                                @error('aadhar_number')
                                          <span style="color:red">{{$message}}</span>
                                @enderror
