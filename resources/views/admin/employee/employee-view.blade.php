            ...
            <div id="form-validation" class="p-5">
                <div class="preview">
                    ...
                    <div class="input-form ">
                        ...
                        <input id="validation-form-1" type="text" class="form-control" placeholder="Name" name="name" value="{{$employeeView->user->name}}">
                    </div>
                    ...
                    <div class="input-form mt-3">
                        ...
                        <input id="regular-form-4" type="email" class="form-control" placeholder="Email" name='email' value="{{$employeeView->user->email}}">
                    </div>
                    <div class="input-form mt-3">
                        <label for="regular-form-4" class="form-label w-full flex flex-col sm:flex-row">
                            Official Email
                    ...
                    <div class="input-form mt-3">
                        ...
                        <input id="regular-form-4" type="date" class="form-control" placeholder="Data of Birth" name='data_of_birth' value="{{$employeeView->date_of_birth}}">
                    </div>
                    <div class="input-form mt-3">
                        <label for="regular-form-4" class="form-label w-full flex flex-col sm:flex-row">
                            Blood Group
                    ...
                    <div class="input-form mt-3">
                        ...
                        <input id="regular-form-3" class="form-control" value="{{$employeeView->roleToUserDetails ? $employeeView->roleToUserDetails->role : '' }}">
                    </div>
                    <div class="input-form mt-3">
                        <label for="regular-form-3" class="form-label w-full flex flex-col sm:flex-row">
                            Team
