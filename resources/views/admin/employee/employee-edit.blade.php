            ...
            <form class="validate-form" action="{{route('employee-update')}}" method="post" id="theForm">
                <input  type="hidden" name="id"  value="{{$employeeEdit->id}}">
                        ...
                        <div class="input-form ">
                         ...
                         <input id="validation-form-1" type="text" class="form-control" placeholder="Name" name="name" value="{{$employeeEdit->name}}" required>       
                        </div>
                        ...
                        <div class="input-form mt-3">
                            ...
                            <input id="regular-form-4" type="email" class="form-control" placeholder="Email" name='email' value="{{$employeeEdit->email}}" >
                        </div>
                        <div class="input-form mt-3">
                            <label for="regular-form-4" class="form-label w-full flex flex-col sm:flex-row">
                        ...
                        <div class="input-form mt-3">
                            ...
                            <input id="regular-form-4" type="date" class="form-control" placeholder="Data of Birth" name='data_of_birth' value="{{$employeeEdit->data_of_birth}}" required>
                        </div>
                        <div class="input-form mt-3">
                            <label for="regular-form-4" class="form-label w-full flex flex-col sm:flex-row">
