            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-2" data-target="#multiple-select" class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-3" data-target="#header" class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-4" data-target="#input-group" class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-5" data-target="#disabled" class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
            ...
            <div class="intro-y box mt-5">
                <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                    ...
                    <div class="w-full sm:w-auto flex items-center sm:ml-auto mt-3 sm:mt-0">
                        ...
                        <input id="show-example-6" data-target="#disabled-option" class="show-code form-check-switch mr-0 ml-3" type="checkbox">
                    </div>
                </div>
