        ...
        <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
            <div class="intro-y box mt-5 lg:mt-0">
                ...
                <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                    <a class="flex items-center text-theme-25 dark:text-theme-22 font-medium" href="">
                    ...
                    <div class="tiny-slider py-5" id="announcement">
                        <div class="px-5">
                            ...
                            <div class="flex items-center mt-5">
                                <div class="px-3 py-2 bg-theme-19 dark:bg-dark-5 dark:text-gray-300 text-theme-22 rounded font-medium">02 June 2021</div>
                            ...
                            <div id="laravel" class="tab-pane active" role="tabpanel" aria-labelledby="top-products-laravel-tab">
                                ...
                                <div class="flex flex-col sm:flex-row items-center mt-5">
                                    ...
                                    <div class="w-full sm:w-auto flex items-center mt-3 sm:mt-0">
                                        ...
                                        <div class="progress h-1 mt-2 sm:w-40">
                                            <div class="progress-bar w-2/3 bg-theme-25" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col sm:flex-row items-center mt-5">
                        ...
                        <div class="tab-content">
                            <div id="work-in-progress-new" class="tab-pane active" role="tabpanel" aria-labelledby="work-in-progress-new-tab">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="progress h-1 mt-2">
                                        <div class="progress-bar w-4/5 bg-theme-25" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
