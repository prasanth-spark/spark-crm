            ...
            <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="report-box-2 intro-y mt-12 sm:mt-5">
                        <div class="box sm:flex">
                            <div class="px-8 py-12 flex flex-col justify-center flex-1">
                                <i data-feather="shopping-bag" class="w-10 h-10 text-theme-15"></i>
                                ...
                                <div class="report-box-2__indicator bg-theme-20 tooltip cursor-pointer" title="47% Higher than last month">
                                ...
                                <button class="btn btn-outline-secondary relative justify-start rounded-full mt-12">
                                    Download Reports
                                    <span class="w-8 h-8 absolute flex justify-center items-center bg-theme-25 text-white rounded-full right-0 top-0 bottom-0 my-auto ml-auto mr-0.5">
                            ...
                            <div class="px-8 py-12 flex flex-col justify-center flex-1 border-t sm:border-t-0 sm:border-l border-gray-300 dark:border-dark-5 border-dashed">
                                ...
                                <div class="mt-1.5 flex items-center">
                                    ...
                                    <div class="text-theme-21 flex text-xs font-medium tooltip cursor-pointer ml-2" title="2% Lower than last month">
                                ...
                                <div class="mt-1.5 flex items-center">
                                    ...
                                    <div class="text-theme-21 flex text-xs font-medium tooltip cursor-pointer ml-2" title="0.1% Lower than last month">
                                ...
                                <div class="mt-1.5 flex items-center">
                                    ...
                                    <div class="text-theme-20 flex text-xs font-medium tooltip cursor-pointer ml-2" title="49% Higher than last month">
                                ...
                                <div class="mt-1.5 flex items-center">
                                    ...
                                    <div class="text-theme-20 flex text-xs font-medium tooltip cursor-pointer ml-2" title="52% Higher than last month">
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 mt-2">
                    <div class="intro-y flex items-center h-10">
                        ...
                        <a href="" class="ml-auto text-theme-30 dark:text-theme-25 truncate">View on Map</a>
                    </div>
                    <div class="report-box-2 intro-y mt-5">
                        <div class="box p-5">
                            ...
                            <div class="border-b border-gray-200 flex pb-2 mt-4">
                                ...
                                <div class="text-theme-20 flex text-xs font-medium tooltip cursor-pointer ml-auto" title="49% Lower than last month">
                                    49% <i data-feather="chevron-up" class="w-4 h-4 ml-0.5"></i>
                                </div>
                            </div>
                ...
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="ads-box box p-8 relative overflow-hidden bg-theme-24 intro-y">
                        ...
                        <img class="hidden sm:block absolute top-0 right-0 w-2/5 -mt-3 mr-2" alt="Tinker Tailwind HTML Admin Template" src="{{ asset('dist/images/woman-illustration.svg') }}">
                    </div>
                </div>
                <!-- END: Ads 1 -->
                <!-- BEGIN: Ads 2 -->
                <div class="col-span-12 lg:col-span-6 mt-6">
                    <div class="ads-box box p-8 relative overflow-hidden intro-y">
                        ...
                        <img class="hidden sm:block absolute top-0 right-0 w-1/2 mt-1 -mr-12" alt="Tinker Tailwind HTML Admin Template" src="{{ asset('dist/images/phone-illustration.svg') }}">
                    </div>
                </div>
                <!-- END: Ads 2 -->
                            ...
                            <tbody>
                                @foreach (array_slice($fakers, 0, 4) as $faker)
                                    <tr class="intro-x">
                                        ...
                                        <td class="w-40">
                                            <div class="flex items-center justify-center {{ $faker['true_false'][0] ? 'text-theme-20' : 'text-theme-21' }}">
                ...
                <div class="2xl:pl-6 grid grid-cols-12 gap-6">
                        ...
                        <div class="report-timeline mt-5 relative">
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">{{ $fakers[7]['products'][0]['name'] }}</a> price and description</div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                <div class="report-timeline__image">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-gray-600 mt-1">Has changed <a class="text-theme-30 dark:text-theme-25" href="">{{ $fakers[6]['products'][0]['name'] }}</a> description</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-6 xl:col-span-4 2xl:col-span-12 mt-3">
                        <div class="intro-x flex items-center h-10">
                            ...
                            <a href="" class="ml-auto text-theme-30 dark:text-theme-25 truncate flex items-center">
                            ...
                            <div class="intro-x box">
                                <div class="p-5">
                                    ...
                                    <div class="grid grid-cols-7 gap-4 mt-5 text-center">
                                        ...
                                        <div class="py-0.5 bg-theme-17 dark:bg-theme-20 rounded relative">6</div>
                                        <div class="py-0.5 rounded relative">7</div>
                                        <div class="py-0.5 bg-theme-24 dark:bg-theme-25 text-white rounded relative">8</div>
                                        ...
                                        <div class="py-0.5 bg-theme-18 dark:bg-theme-29 rounded relative">23</div>
                                        <div class="py-0.5 rounded relative">24</div>
                                        <div class="py-0.5 rounded relative">25</div>
                                        <div class="py-0.5 rounded relative">26</div>
                                        <div class="py-0.5 bg-theme-19 dark:bg-theme-15 rounded relative">27</div>
