...
@section('subcontent')
    ...
    <div class="intro-y box overflow-hidden mt-5">
        <div class="flex flex-col lg:flex-row pt-10 px-5 sm:px-20 sm:pt-20 lg:pb-20 text-center sm:text-left">
            <div class="font-semibold text-theme-25 dark:text-theme-22 text-3xl">INVOICE</div>
            <div class="mt-20 lg:mt-0 lg:ml-auto lg:text-right">
                <div class="text-xl text-theme-25 dark:text-theme-22 font-medium">Left4code</div>
        ...
        <div class="flex flex-col lg:flex-row border-b px-5 sm:px-20 pt-10 pb-10 sm:pb-20 text-center sm:text-left">
            <div>
                ...
                <div class="text-lg font-medium text-theme-25 dark:text-theme-22 mt-2">Arnold Schwarzenegger</div>
            ...
            <div class="mt-10 lg:mt-0 lg:ml-auto lg:text-right">
                ...
                <div class="text-lg text-theme-25 dark:text-theme-22 font-medium mt-2">#1923195</div>
        ...
        <div class="px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row">
            <div class="text-center sm:text-left mt-10 sm:mt-0">
                ...
                <div class="text-lg text-theme-25 dark:text-theme-22 font-medium mt-2">Elon Musk</div>
            ...
            <div class="text-center sm:text-right sm:ml-auto">
                ...
                <div class="text-xl text-theme-25 dark:text-theme-22 font-medium mt-2">$20.600.00</div>
