            ...
            <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                <div class="flex items-center border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                    ...
                    <div class="ml-3 mr-auto">
                        ...
                        <div class="flex text-gray-600 truncate text-xs mt-0.5">
                            <a class="text-theme-25 dark:text-theme-22 inline-block truncate" href="">{{ $faker['products'][0]['category'] }}</a> <span class="mx-1">•</span> {{ $faker['formatted_times'][0] }}
                        </div>
                    </div>
                ...
                <div class="p-5">
                    <div class="h-40 2xl:h-56 image-fit">
                        <img alt="Tinker Tailwind HTML Admin Template" class="rounded-md" src="{{ asset('dist/images/' . $faker['images'][0]) }}">
                    </div>
                ...
                <div class="flex items-center px-5 py-3 border-t border-gray-200 dark:border-dark-5">
                    ...
                    <div class="intro-x flex mr-2">
                        <div class="intro-x w-8 h-8 image-fit">
                            <img alt="Tinker Tailwind HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="{{ asset('dist/images/' . $faker['photos'][0]) }}" title="{{ $faker['users'][0]['name'] }}">
                        </div>
                        <div class="intro-x w-8 h-8 image-fit -ml-4">
                            <img alt="Tinker Tailwind HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="{{ asset('dist/images/' . $faker['photos'][1]) }}" title="{{ $faker['users'][1]['name'] }}">
                        </div>
                        <div class="intro-x w-8 h-8 image-fit -ml-4">
                            <img alt="Tinker Tailwind HTML Admin Template" class="rounded-full border border-white zoom-in tooltip" src="{{ asset('dist/images/' . $faker['photos'][2]) }}" title="{{ $faker['users'][2]['name'] }}">
                        </div>
                    </div>
                    <a href="" class="intro-x w-8 h-8 flex items-center justify-center rounded-full bg-theme-19 dark:bg-dark-5 dark:text-gray-300 text-theme-22 ml-auto tooltip" title="Share">
                        <i data-feather="share-2" class="w-3 h-3"></i>
                    </a>
                    <a href="" class="intro-x w-8 h-8 flex items-center justify-center rounded-full bg-theme-25 text-white ml-2 tooltip" title="Download PDF">
