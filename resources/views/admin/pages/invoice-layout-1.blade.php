    ...
    <div class="intro-y box overflow-hidden mt-5">
        <div class="border-b border-gray-200 dark:border-dark-5 text-center sm:text-left">
            <div class="px-5 py-10 sm:px-20 sm:py-20">
                <div class="text-theme-25 dark:text-theme-22 font-semibold text-3xl">INVOICE</div>
                <div class="mt-2">
            ...
            <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                ...
                <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                    ...
                    <div class="text-lg font-medium text-theme-25 dark:text-theme-22 mt-2">Left4code</div>
